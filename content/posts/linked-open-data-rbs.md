...
> *This is cross posted at [The Scholars' Lab Blog](http://www.scholarslab.org/digital-libraries/introduction-to-linked-open-data-at-rare-books-school/).*
...
<img src="https://lod-cloud.net/versions/2024-08-25/lod-cloud.png" alt="Linked Open Data cloud" height="195" width="300" />
</a>
...
converted it to [Turtle](http://en.wikipedia.org/wiki/Turtle_(syntax)), which
...
- Eric’s given name is “Eric.”
- Eric’s surname is “Rochester.”
...
You can find the source for this example on both Github:
...
(not all of these will be helpful if you're just getting started):
...
*2024-09-15: Minor updates, including updating the image, as I moved it to a new static site generator.*
